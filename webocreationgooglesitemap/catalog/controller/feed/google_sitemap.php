<?php
namespace Opencart\Catalog\Controller\Extension\Webocreationgooglesitemap\Feed;
	...
	public function index() {
		if ($this->config->get('feed_google_sitemap_status')) {
			...
			foreach ($products as $product) {
				...
				if ($product['image']) {
					$output .= '  <image:image>';
					$output .= '  <image:loc>' . $this->model_tool_image->resize($product['image'], 250, 250) . '</image:loc>';
