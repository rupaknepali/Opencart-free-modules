<?php
namespace Opencart\Catalog\Controller\Extension\Webocreationfeeds\Feed;
class GoogleBase extends \Opencart\System\Engine\Controller {
	public function index() {
		if ($this->config->get('feed_google_base_status')) {
			...
			$google_base_categories = $this->model_extension_webocreationfeeds_feed_google_base->getCategories();
